...
<div align="center">
  <a href="https://github.com/mehdi-lakhzouri">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=26&duration=2600&pause=900&color=2DD4BF&center=true&vCenter=true&width=900&lines=Mohamed+Mehdi+Lakhzouri;Cybersecurity+Engineering+Student;Full-Stack+Developer;Secure+Backend+Architecture;DevSecOps+%26+AI-Powered+Security+Automation" alt="Typing SVG" />
  </a>

  <p>
    <strong>Cybersecurity Engineering Student</strong> and <strong>Full-Stack Developer</strong> focused on secure backend architecture, web security, DevSecOps, scalable systems, and AI-powered security automation.
  </p>

  <p>
    <a href="https://github.com/mehdi-lakhzouri?tab=followers">
      <img src="https://img.shields.io/github/followers/mehdi-lakhzouri?style=for-the-badge&logo=github&label=Followers&color=2dd4bf&labelColor=0f172a" alt="GitHub followers" />
    </a>
    <a href="https://github.com/mehdi-lakhzouri?tab=repositories">
      <img src="https://img.shields.io/badge/Repositories-Portfolio-38bdf8?style=for-the-badge&logo=github&logoColor=white&labelColor=0f172a" alt="GitHub repositories" />
    </a>
    <a href="https://www.linkedin.com/in/mohamed-mahdi-lakhzouri/">
      <img src="https://img.shields.io/badge/LinkedIn-mohamed--mahdi--lakhzouri-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn profile" />
    </a>
  </p>
</div>
...
<table>
  <tr>
    ...
    <td>OWASP Top 10, API security, secure authentication, input validation, threat modeling, Burp Suite, OWASP ZAP</td>
  </tr>
  <tr>
    <td><strong>Blue Team</strong></td>
    <td>SOC workflows, SIEM, SOAR, alert triage, detection engineering, Wazuh, TheHive, MISP, OpenCTI</td>
  </tr>
  <tr>
    <td><strong>IAM</strong></td>
    <td>RBAC, Keycloak, identity lifecycle, access control design, secure session and token handling</td>
  </tr>
  <tr>
    <td><strong>DevSecOps</strong></td>
    <td>Docker, Linux, GitHub Actions, SAST, DAST, CI/CD security gates, Nginx hardening</td>
  </tr>
  <tr>
    <td><strong>Security Automation</strong></td>
    <td>Python, OpenAI, machine learning, vector databases, enrichment pipelines, AI-assisted investigation</td>
  </tr>
</table>
...
![Vector Databases](https://img.shields.io/badge/Vector_Databases-111827?style=for-the-badge&logo=databricks&logoColor=FF3621)
...
![Keycloak](https://img.shields.io/badge/Keycloak-111827?style=for-the-badge&logo=keycloak&logoColor=4D4DFF)
![Wazuh](https://img.shields.io/badge/Wazuh-111827?style=for-the-badge&logo=wazuh&logoColor=0277BD)
![TheHive](https://img.shields.io/badge/TheHive-111827?style=for-the-badge&logo=thehive&logoColor=FBBF24)
![MISP](https://img.shields.io/badge/MISP-111827?style=for-the-badge&logo=securityscorecard&logoColor=white)
![OpenCTI](https://img.shields.io/badge/OpenCTI-111827?style=for-the-badge&logo=opencollective&logoColor=7C3AED)
...
<table>
  ...
  <tbody>
    <tr>
      <td><strong>Secure API Platform</strong></td>
      <td>Production-style REST APIs with layered architecture, validation, rate limiting, audit logs, and role-based access.</td>
      <td>NestJS, TypeScript, PostgreSQL, Redis, Docker</td>
      <td>API security, RBAC, secure sessions, OWASP Top 10</td>
    </tr>
    <tr>
      <td><strong>AI Security Automation Lab</strong></td>
      <td>AI-assisted alert enrichment, investigation notes, IOC summarization, and vector-based security knowledge retrieval.</td>
      <td>Python, OpenAI, vector databases, FastAPI, PostgreSQL</td>
      <td>SOAR, SOC automation, detection support</td>
    </tr>
    <tr>
      <td><strong>DevSecOps Pipeline</strong></td>
      <td>CI/CD workflow with automated testing, dependency checks, SAST, DAST, containerization, and deployment hardening.</td>
      <td>GitHub Actions, Docker, Linux, Nginx, OWASP ZAP</td>
      <td>SAST, DAST, supply-chain hygiene, secure delivery</td>
    </tr>
    <tr>
      <td><strong>IAM & Access Control System</strong></td>
      <td>Authentication and authorization patterns for multi-role applications with centralized identity management.</td>
      <td>Keycloak, Next.js, NestJS, PostgreSQL</td>
      <td>IAM, RBAC, token security, least privilege</td>
    </tr>
  </tbody>
</table>
...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/mehdi-lakhzouri/mehdi-lakhzouri/output/github-contribution-grid-snake-dark.svg" />
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/mehdi-lakhzouri/mehdi-lakhzouri/output/github-contribution-grid-snake.svg" />
    <img alt="GitHub contribution snake animation" src="https://raw.githubusercontent.com/mehdi-lakhzouri/mehdi-lakhzouri/output/github-contribution-grid-snake.svg" />
  </picture>
</div>
...
<div align="center">
  <a href="https://www.linkedin.com/in/mohamed-mahdi-lakhzouri/">
    <img src="https://img.shields.io/badge/LinkedIn-Mohamed%20Mehdi%20Lakhzouri-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn" />
  </a>
  <a href="mailto:mehdi-lakhzouri@users.noreply.github.com">
    <img src="https://img.shields.io/badge/Email-mehdi--lakhzouri%40users.noreply.github.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white" alt="Email" />
  </a>
  <a href="https://github.com/mehdi-lakhzouri">
    <img src="https://img.shields.io/badge/GitHub-mehdi--lakhzouri-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" />
  </a>
</div>
...
<div align="center">
  <strong>Secure systems. Clean architecture. Practical automation.</strong>
</div>
